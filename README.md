...
- ✅ Shadow controls (bias, light direction)
- ✅ Shadow debug visualization modes
- ✅ Interactive demo window

**Graphics API**:
- ✅ **Vulkan** (Windows, Linux, macOS)
- ✅ **Metal** (macOS) via metal-cpp - **NEW**
- ⏳ **WebGPU** (next - Milestone 4.2)
- ⏳ **Direct3D 12** (postponed to Phase 8)
...
- **Milestone 4.1: Metal Backend Implementation** ✅ **NEW**
