...
/**
 * @brief LOD level: an alternate index buffer with fewer triangles
 */
struct LODLevel {
...
public:
    ...
    int GetLODCount() const;  // Total LOD levels available (1 to 3)
...
private:
    ...
    // LOD1 (50% triangles) and LOD2 (20% triangles) — generated by meshoptimizer
    std::array<LODLevel, 2> m_LODLevels;
